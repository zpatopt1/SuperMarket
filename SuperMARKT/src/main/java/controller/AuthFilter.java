...
public class AuthFilter implements Filter {
    ...
    private static final Set<String> REPOSITOR_ONLY = new HashSet<>(Arrays.asList(
            ...
            "/DownloadEncomendaCsvServlet",
            "/ConfirmarEncomendaFornecedorServlet",
            "/ConfirmarRececaoEncomendaServlet",
            ...
            "/Front-end/pages/confirmar_encomenda_fornecedor.jsp",
            "/Front-end/pages/confirmar_rececao_encomenda.jsp",
